...
const ENDPOINT = "https://team-collaboration-chat.onrender.com";
  ...
  const fetchMessages = async () => {
    ...
    try {
      ...
      const { data } = await axios.get(
        `https://team-collaboration-chat.onrender.com/api/message/${selectedChat._id}`,
        config
      );
    ...
    if (event.key === "Enter" && newMessage) {
      ...
      try {
        ...
        const { data } = await axios.post(
          "https://team-collaboration-chat.onrender.com/api/message",
          {
            content: newMessage,
            chatId: selectedChat,
          },
